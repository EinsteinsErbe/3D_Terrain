Shader "Custom/Terrain2" {
    Properties {
		...
		_SnowMinHeight("Snow Min Height", Range(0,1)) = .8
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			float snowWeight = smoothstep(_SnowMinHeight, 1, normalizedHeight);
			...
			grassWeight = min(grassWeight, 1 - snowWeight);
			float3 terrainCol = _MainCol * (1 - grassWeight - snowWeight) + grassWeight * _GrassColour + snowWeight * _SnowColour;
